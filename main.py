...
class window: 
    ...
    def __init__(self,root,title) -> None:
        ...
        # _______________BUTONLAR___________________
        ...
        start_btn = ttk.Button(self.root, text='Baslat', padding=5, width=15,
                            command=self.start)
        ...
        ttk.Button(self.root, text='Karistir', style='info.Outline.TButton', padding=5, width=15,
        ...
        ttk.Label(self.root, text='Hiz ve Dizi Boyutu:').grid(row=2,column=0)
        ...
        # ________________ Renk dizileri _________________
    ...
    def display(self,N: int,a: list,rong: list)-> None:
        '''
        N = dikdörtgen sayisi
        a = dikdörtgen yükseklik dizisi
        rong = her bir dikdörtgenin renk dizisi
        '''
    ...
    def shuffle(self):
     ...
     # ---------------sıralama algoritmalarının düğme seçimi---------------------------
    ...
    def start(self):
        if self.sorts['bubble'] is True:
            ...
            messagebox.showerror("Algoritma Görüntüleyici", "Herhangi bir sıralama algoritması seçmediniz")
